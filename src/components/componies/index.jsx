...
function FlyCompanies() {
  ...
  const passengerAmount = useSelector(
    (state) => state.passAmount.passengerAmount
  );
  ...
  const totalPassenger =
    passengerInfo.adults + passengerInfo.children + passengerInfo;
  ...
  const handleTicketClick = (ticket) => {
    dispatch(
      setFlightTicket({ ...ticket, selectedDate: selectedDateTimestamp })
    );
